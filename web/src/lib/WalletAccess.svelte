<script lang="ts">
  ...
  import {wallet, builtin, chain, transactions, balance, flow, fallback} from '$lib/stores/wallet';
      ...
      <div class="text-center">
        ...
        <div class="ml-8 mt-6 text-cyan-100 text-xs">
          <label class="flex items-center">
            ...
            {#if onSharedStorage}
              <span class="ml-2 text-gray-500">Do not ask again. (option disabled as app is served from shared host)</span>
