...
interface IUniswapV2PairWithRawLiquidityProvisionOption /*is IUniswapV2Pair*/ {
    function mintWithRawLiquidityProvision(address to1, address to2) external returns (uint liquidity);
